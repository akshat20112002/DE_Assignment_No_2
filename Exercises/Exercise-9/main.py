...
#     # Read CSV with schema fix (end_station_id as string)
#     pl_df = pl.read_csv(csv_path, schema_overrides={"end_station_id": pl.Utf8})
...
#         .group_by("date")
#         .agg(pl.len().alias("ride_count"))  # replaced deprecated pl.count()
#         .sort("date")
#     )
...
#     daily_counts.write_csv(daily_path)
#     weekly_stats.write_csv(weekly_path)
#     first_last_ride.write_csv(compare_path)
